  ...
  if (products.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-16 text-gray-400">
        ...
        <p className="text-sm">Belum ada product. Tambah product pertama lo!</p>
      </div>
    );
  }
    ...
    <div>
      <div className="flex gap-6 mb-5 text-sm">
        <div className="flex flex-col">
          <span className="text-gray-400 text-xs uppercase tracking-wide">Total Product</span>
          <span className="font-semibold text-gray-800">{count}</span>
        </div>
        <div className="w-px bg-gray-200" />
        <div className="flex flex-col">
          <span className="text-gray-400 text-xs uppercase tracking-wide">Total Stok</span>
